...
pointed out, and settles on the dates still used today.
...
Russell began his count from 536 B.C. which he claimed was Cyrus' first year. Now Cyrus' first year is correctly
understood to be 538 B.C. and the count is actually started from Cyrus' second year 
...
Again as we have already noted in section [Return of the Exiles](../70_years/return.md) no adequate justification
as to how we can know Cyrus' edict was given at the end (rather than the start) of his first year, and that the
...
They of course also date the 18th/19th year of Nebuchadnezzar to 587/576 B.C. thereby contradicting the Watchtower's
chronology [@dubberstein1942babylonian, 26].
...
reign on the Julian/Gregorian calendar, as we saw in section [Business Tablets](../../orthodox/business/README.md)
there are over 100 similar tablets dated to Cyrus' first year.
